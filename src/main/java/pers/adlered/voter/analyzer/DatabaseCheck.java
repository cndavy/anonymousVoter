        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    SQL= "Create table `Voter_Vote_Detail`  (\n" +
                        " `ID` int(11) NOT NULL AUTO_INCREMENT,\n" +
                            "    `VID` int(11) NOT NULL  ,\n" +
                        " foreign key(`VID`) references `Voter_Vote`(`VID`),\n" +
                        "  `Detail` varchar(10000) CHARACTER SET utf8mb4 DEFAULT NULL,\n" +
                            "  PRIMARY KEY (`ID`)\n" +
                            ") ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;";
                    statement.executeUpdate(SQL);

                    SQL= "Create table `Voter_Vote_Token`  (\n" +
                            " `ID` int(11) NOT NULL AUTO_INCREMENT,\n" +
                        "    `VID` int(11) NOT NULL  ,\n" +
                    " foreign key(`VID`) references `Voter_Vote`(`VID`),\n" +
                            ...
                            ") ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;";
                    statement.executeUpdate(SQL);
//                    SQL = "INSERT INTO `Voter_Vote` VALUES (1, 'This is a vote title :)', 'And here is a describe of the vote XD'," +
//                            " '<%1<%92<%Vote for Xiaoli<%2<%42<%Vote for Zhanghua<%3<%41<%Vote for Ergou<%4<%37<%Vote for Guawazi<%5<%48<%Vote for Benwei<%6<%50<%Vote for Adler', '<%1<%92<%Vote for Xiaoli<%2<%42<%Vote for Zhanghua<%3<%41<%Vote for Ergou<%4<%37<%Vote for Guawazi<%5<%48<%Vote for Benwei<%6<%50<%Vote for Adler', 0, 2);";
//                    statement.executeUpdate(SQL);
